...
```{r}
shiny_g2 <- function(params, dat = NULL)
{
      ...
      lapply(1:n_spec, function(i) {
        div(
          ...
          numericInput(inputId = paste0('gamma', i),
                       "Search volume:", 
                       # min = .1*params_shiny@species_params$gamma[i], 
                       # max = 10*params_shiny@species_params$gamma[i],
...
Now need to optimise again with the new growth curves
